...
# Phase 1: 系統設定與底層初始化
# ==========================================
st.set_page_config(page_title="JARVIS 簡報萬用導航器 v2.1", page_icon="🎨", layout="wide")

# ==========================================
# Phase 2: UI 介面與功能選單定義
# ==========================================
st.title("🚀 JARVIS 資訊視覺化簡報 Prompt 生成器 v2.1")
st.markdown("BOSS，全場景構圖控制模組已就緒。請設定您的簡報戰略參數。")
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("v2.1 空間控制版 | 核心：字串拼接 | Mac M4 Pro")
...
# 功能 12：視覺風格
st.subheader("🎨 功能 12: 視覺風格 (Visual Style)")
styles = [
...
style_choice = st.selectbox("選擇視覺語彙：", styles)
...
raw_text = st.text_area("在此貼上文稿或摘要 (建議 5,000 字內)：", height=150)
...
with col_btn1:
    st.download_button("📥 下載 .md", final_prompt, "v2_1_prompt.md", "text/markdown", use_container_width=True)
with col_btn2:
